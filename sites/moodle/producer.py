...
async def producer(session, queue, base_path, site_settings, id, use_external_links=True):
    ...
    return await parse_main_page(session, queue, html, base_path, site_settings, id, use_external_links)
