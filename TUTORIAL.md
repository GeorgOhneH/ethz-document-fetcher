...
The CLI is in not faster then the GUI, but it can be useful 
if you want to run the application on a server and sync the folder with your pc.
...
But if a required value is neither in the settings or the arguments, you will get an error.
